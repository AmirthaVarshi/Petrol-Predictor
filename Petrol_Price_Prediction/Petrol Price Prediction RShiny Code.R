...
dataread<-read.csv("M:\\DM PROJECT\\Petrol_Price_Prediction\\Data\\petrol5.csv", header = T)

#Loading the dataset
data <- read.csv("M:\\DM PROJECT\\Petrol_Price_Prediction\\Data\\Petrol Price Original.csv", header = T)
datapp <- read.csv("M:\\DM PROJECT\\Petrol_Price_Prediction\\Data\\actual_data_to_compare.csv", header = T)
